...
const testimonials = [
  {
    ...
    quote: 'Within 6 weeks, my sleep transformed completely. I wake up without an alarm, think more clearly, and my metabolic markers improved beyond what my doctor expected. Capacity Lab OS changed everything.',
